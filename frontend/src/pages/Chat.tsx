...
const Chat = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] w-full overflow-hidden bg-background">
      ...
      {crisisData && (
        <div className="fixed inset-0 z-50 bg-background/95 backdrop-blur-sm flex flex-col items-center justify-center p-4 text-center animate-in fade-in duration-300 overflow-y-auto">
          <div className="max-w-sm w-full space-y-4 my-auto">
            <div className="flex flex-col items-center gap-2 text-destructive">
              <Activity className="h-12 w-12 animate-pulse" />
              <h1 className="text-2xl font-bold tracking-tighter">MEDICAL ALERT</h1>
            </div>

            <div className="space-y-3">
              <div className="bg-card border-2 border-destructive/20 p-4 rounded-xl shadow-lg">
                <h3 className="text-lg font-semibold mb-1">Primary Directive</h3>
                <p className="text-base leading-relaxed font-medium">
                  {crisisData.immediate_action.primary_directive}
                </p>
              </div>

              <div className="bg-primary/5 p-6 rounded-full w-40 h-40 mx-auto flex items-center justify-center animate-pulse duration-[4000ms]">
                <div className="text-center flex flex-col items-center justify-center h-full px-3">
                  <p className="text-[10px] text-muted-foreground uppercase tracking-widest mb-0.5">Grounding</p>
                  <p className="font-semibold text-xs leading-tight text-primary">
            ...
            <div className="space-y-2 pt-2">
              {crisisData.immediate_action.emergency_contacts.map((contact, idx) => (
                <Button
                  ...
                  variant="destructive"
                  size="lg"
                  className="w-full h-12 text-base font-bold gap-2 shadow-xl hover:scale-105 transition-transform"
